...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, DASH_DOWN, DASH_UP, GORUN = range(8)
...
next_state_table = {
    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState, LEFT_DOWN: RunState, SLEEP_TIMER: SleepState, DASH_UP: IdleState, DASH_DOWN: IdleState},
    ...
    DashState: {DASH_UP: RunState, RIGHT_UP: IdleState, LEFT_UP: IdleState, GORUN: RunState},
